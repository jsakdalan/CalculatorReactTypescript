...
export default function Calculator(){
    ...
    const Buttons = (props:Buttons) => {
        return(
            <Button className={props.styling} onClick={props.clickEvent}>
                {props.btnNumber}
            </Button>
        )
    }

    const trying = (event: MouseEvent, num: number) =>{
        console.log('pass');
                ...
                <Row>
                    <Col md={9}>
                        <Row>
                            <Col md={12}>
                                <Row>
                                    <Col md={3}><Buttons styling="numerical" btnNumber="1" clickEvent={trying()}/></Col>
