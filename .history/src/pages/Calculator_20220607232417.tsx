                ...
                <Row>
                    <Col md={9}>
                        <Row>
                            ...
                            <Col md={12}>
                                <Row>
                                    <Col md={3}><Buttons styling="numerical" btnNumber="7" clickEvent={btnValue} inputValue={3}/></Col>
                                    <Col md={3}><Buttons styling="numerical" btnNumber="8" clickEvent={btnValue} inputValue={3}/></Col>
                                    <Col md={3}><Buttons styling="numerical" btnNumber="9" clickEvent={btnValue} inputValue={3}/></Col>
                                    <Col md={3}><Buttons styling="operational" btnNumber="-"/></Col>
                                </Row>
                            </Col>
                            <Col md={12}>
                                <Row>
                                    <Col md={9}><Buttons styling="numerical" btnNumber="0" clickEvent={btnValue} inputValue={3}/></Col>
